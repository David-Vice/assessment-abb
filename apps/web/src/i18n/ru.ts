const ru = {
  ...
  chat: {
    ...
    offTopic:
      'Этот вопрос выходит за рамки моих возможностей. Я могу отвечать только на вопросы о банке ABB.',
    injection:
      'Обнаружена потенциальная попытка инъекции. Пожалуйста, задайте настоящий вопрос о банке ABB.',
